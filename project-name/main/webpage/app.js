...
/*
    Gets DHT22 Sensor Temperature and Humidity valeus for display on the web page
*/
...
/*
    Clears the conenction status interval
*/
...
function getWifiConnectStatus()
{
    ...
    //readyState = 4 means that it's been sent, status = 200 means it's "ok"
    if(xhr.readyState == 4 && xhr.status == 200)
    {
        var response = JSON.parse(xhr.responseText);
...
/*
    Starts the interval for hecking the connection status
*/
...
function checkCredentials()
{
    ...
    //check if the SSID or password or empty, if they are display error messages, otherwise connect call connectWifi
    if(selectedSSID == "")
    {
...
function showPassword()
{
    ...
    //if the checkbox is checked show the password, otherwise keep it hidden
...
function disconnectWifi()
{
    ...
    //Update the web page
    //when the disconnect button is pressed, location.reload is invoked
    //and refreshed the page after two seconds
...
/*
    Gets the local time
    conenct the ESP32 to the internet, and the time will be updated
*/
