...
/// Using this LED: https://www.kingbrightusa.com/images/catalog/SPEC/WP154A4SUREQBFZGC.pdf
...
/*
  Init the RGB LED settings per channel, including the GPIO for 
  each color, mode, and timer config.  
*/
...
{
    //Value should be 0 - 255 for 8 number
