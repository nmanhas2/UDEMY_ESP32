...
static void sntp_time_sync_obtain_time(void)
{
    ...
    //Check the time, in ccase we need to inititalzie/reinitialize
...
{
    xTaskCreatePinnedToCore(&sntp_time_sync, "sntp_time_sync", SNTP_TIME_SYNC_TASK_TASK_SIZE, NULL, SNTP_TIME_SYNC_TASK_PRIORITY, NULL, SNTP_TIME_SYNC_TASK_CORE_ID);
